# Generated by Django 3.2 on 2023-05-26 21:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.SmallIntegerField(db_index=True, validators=[django.core.validators.MaxValueValidator(2023, message='Год выпуска не должен быть в будущем времени')], verbose_name='Год выпуска')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score', models.PositiveSmallIntegerField(blank=True, default=0, null=True, validators=[django.core.validators.MinValueValidator(1, 'Оценка должна быть от 1 до 10'), django.core.validators.MaxValueValidator(10, 'Оценка должна быть от 1 до 10')])),
